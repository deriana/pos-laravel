...
@section('content')
    ...
    <div class="container mt-4" id="payment-container" data-grand-total="{{ $purchase->grand_total }}">
        <div class="row">
            <!-- Left: Order Details -->
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h5>Order ID: {{ $purchase->invoice_number }}</h5>
                    </div>
                    <div class="card-body">
                        <table class="table">
                            <thead>
                            ...
                            <tbody>
                                ...
                                <tr class="table-light">
                                    ...
                                    <td class="text-end"><strong>Rp{{ number_format($purchase->grand_total, 2) }}</strong>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
            ...
            <div class="col-md-6">
                ...
                <form id="payment-form" action="{{ route('confirmation.purchase.transaction', $purchase->id) }}"
                    method="POST">
                    @csrf
